...
I see these approaches as providing a robust structure to policy decision making processes such as those carried out by IPBES. Transformative change infers to some extent rapid decision making; my approaches facilitate robust rapid decision making, allow opportunities and challenges on a system level to be identified and prioritised, and can be rapidly updated in the face of new knowledge.    
